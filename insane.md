...
![Rdialog](assets/Rdialogcommand_cmd.png)
Type this command
![Rdialog](assets/IPCONFIG_1.png)
![Rdialog](assets/IPCONFIG_2.png)
...
1.
![Rdialog](assets/Rdialogcommand.png)
2.
![Rdialog](assets/control_panel_network_cards.png)
3.
![Rdialog](assets/control_panel_network_cards_properties.png)
4. Fill in the cases with those numbers (from ipconfig)
![Rdialog](assets/control_panel_network_cards_properties_IP_vide.png)
validate and quit.
